...
class ddpg_agent:
    def __init__(self, args, env, env_params):
        ...
        self.her_module = her_sampler(self.args.replay_strategy, 
            self.args.replay_k, self.env.compute_reward, args.gamma, args.off_goal)
    ...
    def _update_network(self):
        ...
        actor_loss = -self.critic_network(duplicated_g_input, actions_real).mean() + self.args.entropy_regularization*log_prob.mean()
