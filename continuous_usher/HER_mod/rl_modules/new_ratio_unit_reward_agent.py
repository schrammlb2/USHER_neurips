...
from HER_mod.rl_modules.models import unit_reward_ratio_critic as critic
...
class ValueEstimator:
  def __init__(self, env_params, args):
    ...
    self.critic_1 = critic(env_params, args)
    sync_networks(self.critic_1)
    self.critic_target_1 = critic(env_params, args)
    self.critic_target_1.load_state_dict(self.critic_1.state_dict())    
    if self.double_q: 
        self.critic_2 = critic(env_params, args)
        sync_networks(self.critic_2)
        self.critic_target_2 = critic(env_params, args)
  ...
  def q_loss(self, preprocced_tuple, actor, transitions):
    ...
    with torch.no_grad():        
        ...
        if self.args.non_terminal_goals: 
            ...
            target_q_value = r_tensor  + self.args.gamma * q_next_value #* (1-r_tensor)
